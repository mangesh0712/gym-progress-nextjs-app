...
export const exercises: Record<string, ExerciseItem[]> = {
  chest: [
    { id: 'chest-1', name: 'Dumbbell Press', color: 'from-red-400 to-red-600' },
    { id: 'chest-2', name: 'Flat Bench Press', color: 'from-red-500 to-red-700' },
  ...
  legs: [
    { id: 'legs-1', name: 'Squats', color: 'from-blue-400 to-blue-600' },
  ...
  shoulders: [
    { id: 'shoulders-1', name: 'Overhead Press', color: 'from-purple-400 to-purple-600' },
    { id: 'shoulders-2', name: 'Lateral Raises', color: 'from-purple-500 to-purple-700' },
    { id: 'shoulders-3', name: 'Front Raises', color: 'from-pink-400 to-pink-600' },
    { id: 'shoulders-4', name: 'Arnold Press', color: 'from-pink-500 to-pink-700' },
  ],
  back: [
    { id: 'back-1', name: 'Pull Ups', color: 'from-green-400 to-green-600' },
  ...
  biceps: [
    { id: 'biceps-1', name: 'Barbell Curls', color: 'from-yellow-400 to-yellow-600' },
    ...
    { id: 'biceps-4', name: 'Preacher Curls', color: 'from-amber-500 to-amber-700' },
  ],
  triceps: [
    { id: 'triceps-1', name: 'Tricep Dips', color: 'from-indigo-400 to-indigo-600' },
    { id: 'triceps-2', name: 'Skull Crushers', color: 'from-indigo-500 to-indigo-700' },
    { id: 'triceps-3', name: 'Tricep Pushdowns', color: 'from-violet-400 to-violet-600' },
    { id: 'triceps-4', name: 'Close Grip Bench', color: 'from-violet-500 to-violet-700' },
  ],
  abs: [
